...
ul li a {display:block; padding:.6rem 5px; text-decoration: none;}
...
div.content header h3 {background-color: rgba(51,51,51,.7); color:#ddc; padding:10px; margin:0;}
div.content h4 {padding: .5rem 5px; margin:0; background-color: rgba(150,150,150,.3);}
