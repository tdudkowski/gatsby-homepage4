    ...
    return (
        <Layout>
            ...
            <section className="section-meta">
                ...
                <p>Wszystko to za 200 zł / rok, przy czym kolejne przedłużenia są coraz tańsze, aż do 160 zł. Jeżeli szukasz hostingu to jest trochę wyższa cena za dużo większe konto podstawowe. Inni dostawcy oferują sporo mniejsza pojemność i tylko dwa rodzaje baz za ~150 zł.</p>
                ...
                <p>Jest to <em>win-win situation</em>, zatem zapraszam - <a href="http://www.mydevil.net/pp/D021IEO0NN">Mój link afiliacyjny</a> (ewentualnie kod do wpisania w panelu: D021IEO0NN).</p>
            </section> 
...
export function Head() { return ( <Seo title="Hosting" /> ) }