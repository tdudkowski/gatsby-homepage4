...
- XSS cross-site scripting [Sekurak "Czym jest XSS?"](https://sekurak.pl/czym-jest-xss/)
...
- HttpOnly zabezpiecza przed JS w ataku XSS
...
- MDN [Web Storage API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API) | [Window.sessionStorage](https://developer.mozilla.org/en-US/docs/Web/API/Window/sessionStorage)
