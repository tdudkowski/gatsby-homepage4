...
Opcjonalnie do zarządzania różnymi wersjami Node'a - [nvm-sh / nvm](https://github.com/nvm-sh/nvm). Przydaje się.
...
- gatsby-config.js - plik konfiguracyjny, obligatoryjny [Gatsby Config API](https://www.gatsbyjs.com/docs/reference/config-files/gatsby-config/)
