...
- Newsletter, którego powstanie miało być praktyką po kursie [Mailketingu](https://mailketing.pl/) (który polecam) i który stał się bezpośrednią przyczyną tego, że teraz, a nie np. w przyszłym roku przeniosłem treść na Gatsby'ego. Przygotowałem infrastrukturę: maile, przekierowania na gmailu i skonfigurowany profil na MailerLite, ale żeby można było z tym ruszyć, trzeba było mieć wystarczający zapas napisanych na 100% wpisów i czas na korektę treści (błędy składni czy literówki w newsletterze to straszna, bo nienaprawialna wtopa). Może w przyszłym roku.
