...
const LayoutFB = ({ children }) => {
    ...
    const menuEuropaArray = [{ slug: "bulgaria", title: "Bułgaria" }, { slug: "chorwacja", title: "Chorwacja" }, { slug: "rumunia", title: "Rumunia" }, { slug: "slowacja", title: "Słowacja" }, { slug: "wegry", title: "Węgry" },]
    ...
    return (
        <StyledContainer>
            ...
            <StyledFooter>
                <p>Festung Breslau 1945 täglich @ die <a href="https://www.gatsbyjs.com/">GatsbyJS</a> Ausgabe 2022</p>
